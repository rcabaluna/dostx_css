                            ...
                            <div class="p-b-15 p-t-20 dropdown-menu pop-profile">
                                <div class="p-h-20 p-b-15 m-b-10 border-bottom">
                                    <div class="d-flex m-r-50">
                                        ...
                                        <div class="m-l-10">
                                            <p class="m-b-0 text-dark font-weight-semibold"><?= strtoupper($this->session->userdata('username')) ?></p>
                                            <p class="m-b-0 opacity-07"><?= $this->session->userdata('office') ?></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <?php
                                        ...
                                        $this->load->database();
                                        $query = $this->db->query("SELECT quarterid FROM tblquarters WHERE is_active = 1");
